...
def balanced(m):
    ...
    l_value = length(left(m)) * total_weight(l)
    r_value = length(right(m)) * total_weight(r)
    return balanced(l) and balanced(r) and l_value == r_value
...
def replace_leaf(t, find_value, replace_value):
    ...
    # for b in branches(t):
    #     if is_leaf(b):
    #         if label(b) == find_value:
    #             label(b) = replace_value
    #     else:
